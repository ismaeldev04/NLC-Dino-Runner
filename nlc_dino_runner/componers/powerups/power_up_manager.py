...
from nlc_dino_runner.componers.powerups.pacman_power_up import Pacman
...
class PowerUpManager:
    def __init__(self):
        ...
        self.pacman_sound = pygame.mixer.Sound("pacman_sound.mpeg")
        self.shield_sound = pygame.mixer.Sound("shield_sound.mpeg")
